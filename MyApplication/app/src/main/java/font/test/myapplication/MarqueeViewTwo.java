...
public class MarqueeViewTwo extends HorizontalScrollView implements Runnable{
    ...
    public MarqueeViewTwo(Context context) {
        this(context, null);
    }

    public MarqueeViewTwo(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MarqueeViewTwo(Context context, AttributeSet attrs, int defStyle) {
